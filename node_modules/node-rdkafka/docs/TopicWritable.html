...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TopicWritable</title>
...
<article>
    ...
    <h4 class="name" id="TopicWritable">
        <span class="type-signature"></span>new TopicWritable<span class="signature">(producer, topics, options)</span><span class="type-signature"></span>
    </h4>
...
<dl class="details">
    ...
    <dd class="tag-source">
        <ul class="pager"><li>
        <a href="util_topicWritable.js.html#line39">util/topicWritable.js, line 39</a>
        </li></ul>
    </dd>

...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TopicReadable</title>
...
<article>
    ...
    <h4 class="name" id="TopicReadable">
        <span class="type-signature"></span>new TopicReadable<span class="signature">(consumer, topics, options)</span><span class="type-signature"></span>
    </h4>
...
<div class="description">
    <p>ReadableStream integrating with the Kafka Consumer.
...
This stream operates in objectMode. It streams {Consumer~Message}</p>
</div>
...
<span class="param-type">Consumer</span>
            ...
            <td class="description last">The Kafka Consumer object.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Options to configure the stream.
                <h6>Properties</h6>
...
<span class="param-type">number</span>
            ...
            <td class="description last">Number of ms to wait if Kafka reports
that it has timed out or that we are out of messages (right now).</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source">
        <ul class="pager"><li>
        <a href="topic-readable.js.html#line47">topic-readable.js, line 47</a>
        </li></ul>
    </dd>
